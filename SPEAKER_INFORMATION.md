...
First of all: Thanks a lot that you will be a speaker at the Web Engineering Aachen at `<WEEKDAY_OF_MEETUP>`, `<DATE_OF_MEETUP>` [1]. Such events would not be possible without you.
Up to now, `<NUMBER_OF_PEOPLE>` people have registered.
